				...
				<div class="card brad-20">
					<div class="card-body brad-20 shadow">
						<div class="my-3">
							...
							<?= form_open('index.php/password_reset/reset?code='.$code.'&email='.$email.''); ?>
								...
								<button type="submit" name="submit" class="btn btn-primary btn-block brad-20">Reset Password &rarr;</button>
							<?= form_close(); ?>
